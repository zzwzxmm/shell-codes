...
### Load gromacs
module purge
module load GROMACS/5.1.2-intel-2016a-avx2-hybrid

#module load GROMACS/5.0.4-ictce-7.2.4-avx2-hybrid
MDRUN="srun --cpu_bind=verbose gmx_mpi mdrun -ntomp ${SLURM_CPUS_PER_TASK}"
...
$MDRUN -nice 0 -deffnm dtpc-sma-md -v -stepout 1000 -maxh 72 -cpi -rdd 2.0
