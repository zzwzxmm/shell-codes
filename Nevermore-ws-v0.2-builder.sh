...
MARTINI="#include \"$HOMEDIR/common_files/martini_v2.2p.itp\" "
MARTINIEM="#include \"$HOMEDIR/common_files/martini_v2.2pem.itp\" "
MARTINIPARTICLES="#include \"$HOMEDIR/common_files/martini_particles.itp\" "

# Martini lipid itp files
DPPC="#include \"$HOMEDIR/common_files/martini_DPPC.itp\" "
DOPC="#include \"$HOMEDIR/common_files/martini_DOPC.itp\" "
DLPC="#include \"$HOMEDIR/common_files/martini_DLPC.itp\" "
DTPC="#include \"$HOMEDIR/common_files/martini_DTPC.itp\" "

# SMA itp file
SMA="#include \"$HOMEDIR/common_files/sma_cg-23units.itp\" "

# Position Restraints files
SMAPOSRES="#include \"$HOMEDIR/common_files/sma-posres.itp\" "	# If SMAPOSRES is used, SMA should be abandoned
DPPCPOSRES="\
#ifdef POSRES
#include \"$HOMEDIR/common_files/dppc-posres.itp\"
#endif
"
DOPCPOSRES="\
#ifdef POSRES
#include \"$HOMEDIR/common_files/dopc-posres.itp\"
#endif
"
DLPCPOSRES="\
#ifdef POSRES
#include \"$HOMEDIR/common_files/dlpc-posres.itp\"
#endif
"
DTPCPOSRES="\
#ifdef POSRES
#include \"$HOMEDIR/common_files/dtpc-posres.itp\"
#endif
"
